...
#define STRING_CONFIG_H_AUTHOR "Tyler Chelf" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 (SKR Mini E3 v1.2)"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "a5520f0c-e436-4dd5-b2a2-6807c010c552"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 138.81 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-53.49, -15.69, -3.70}

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 2.5
